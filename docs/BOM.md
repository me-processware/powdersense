...
- **Alternative**: Any 10kΩ linear slide pot with 60mm travel

![Bourns Slide Potentiometer](images/bourns_potentiometer.png)
...
- **Alternative**: Similar compression spring with ~0.5-1.5 N/mm spring rate
...
- **Alternative**: Standard bronze bushings or linear ball bearings
...
**Found a better source or alternative?** Please share in GitHub Discussions to help the community!
...
|---------|------|---------|
| 1.0 | Nov 2025 | Initial BOM with verified component links |

---

*Bill of Materials compiled by Processware - November 2025*  
*Part of the PowderSense Open Source Project*

**Last verified**: November 2025  
**Next review**: Quarterly (or when component availability changes)
