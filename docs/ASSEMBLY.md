...
1. Rod preparation (groove and thread)
2. Potentiometer modification (trimmed pins)
3. Mechanical assembly (rod, bearings, spring)
4. Wiring (before closing enclosure)
5. Completed assembly (exterior)

**For sharing with community**:
- Upload to GitHub Discussions
- Post on social media with #PowderSense
