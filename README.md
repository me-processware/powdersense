...
### Future Possibilities (v2.x)

- [ ] Multi-sensor support (parallel measurements)
...
See [ROADMAP.md](docs/ROADMAP.md) for detailed timeline and priorities.
...
- **Website**: https://powdersense.com (TBD)
